...
def access_text(repo_url: str) -> str:
    return (
        ...
        "4. Claude вернет JSON. Скопируйте его целиком.\n"
        "5. Скачайте из репозитория файл goodkp.html и откройте его в браузере на компьютере.\n"
        "6. Вставьте JSON в поле, нажмите «Собрать отчет», затем «Сохранить HTML». "
        "Готовый файл можно отправлять кому угодно.\n\n"
