...
def access_text(repo_url: str) -> str:
    return (
        ...
        "Как прогнать свое КП, если хотите попроще\n"
        "1. Откройте в репозитории файл prompt.md и скопируйте его целиком.\n"
        "2. Вставьте в чат с моделью, например с Claude.\n"
        ...
        "4. Модель вернет JSON. Скопируйте его полностью.\n"
        "5. Откройте paste.html из репозитория в браузере, вставьте JSON в поле.\n"
        "6. Отчет соберется на странице. Нажмите «Сохранить HTML» и отправляйте файл кому нужно.\n\n"
        "Как прогнать свое КП, если хотите через терминал\n"
